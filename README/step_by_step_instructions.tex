...
The tables and plots produced by the artifact are different from the ones in the
...
%
Firstly, \BayesWC{} and \BayesPC{} have higher percentages of sound cost bounds
than \Opt{} (in both data-driven and hybrid resource analysis).
%
