...
type analysis_mode = Mupper | Mlower | Mconstant

module type AMODE = sig
...
let ocaml_prob_module = "Rprob"

let persistent_modules =
  [ ocaml_raml_module; ocaml_nat_module; ocaml_array_module; ocaml_prob_module ]
