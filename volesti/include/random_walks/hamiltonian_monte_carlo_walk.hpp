...
// Flags for debugging the C++ and R interfaces of reflective HMC added by Long
// Pham
// #define DEBUG_CPP
// #define DEBUG_R
#ifdef DEBUG_R
...
#ifdef DEBUG_CPP
        // Debugging in the C interface of volesti
        std::cout << "x: " << x.getCoefficients().transpose() << std::endl;
        std::cout << "v: " << v.getCoefficients().transpose() << std::endl;
        std::cout << "x_tilde: " << x_tilde.getCoefficients().transpose() << std::endl;
        std::cout << "v_tilde: " << v_tilde.getCoefficients().transpose() << std::endl;
        std::cout << "H: " << H << " H_tilde: " << H_tilde << std::endl;
        std::cout << "u_logprob: " << u_logprob << " log_prob: " << log_prob << std::endl;
#endif

#ifdef DEBUG_R
        // Debugging in the R interface of volesti
        Rcpp::Rcout << "x: " << x.getCoefficients().transpose() << "\n";
        Rcpp::Rcout << "v: " << v.getCoefficients().transpose() << "\n";
        Rcpp::Rcout << "x_tilde: " << x_tilde.getCoefficients().transpose() << "\n";
        Rcpp::Rcout << "v_tilde: " << v_tilde.getCoefficients().transpose() << "\n";
        Rcpp::Rcout << "H: " << H << " H_tilde: " << H_tilde << "\n";
        Rcpp::Rcout << "u_logprob: " << u_logprob << " log_prob: " << log_prob << "\n";
#endif
